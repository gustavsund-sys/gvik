...
function drawAreasAndAxis(){
  clearEntities(areaEntities);clearEntities(axisEntities);mapLabelLayout=[];if(axisDragEntity){viewer.entities.remove(axisDragEntity);axisDragEntity=null}if(state.view==='overview')return;
